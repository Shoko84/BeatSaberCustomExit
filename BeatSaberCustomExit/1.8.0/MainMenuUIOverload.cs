    ...
    internal class MainMenuUIOverload : MonoBehaviour
    {
        ...
        private void SetupConfirmQuitPanel()
        {
            ...
            if (ExitPanelController != null)
                ...
                Plugin.Log.Error("[CustomExit.MainMenuUIOverload]: 'ExitPanelController' was null.");
        }
        ...
        private void ChangeForPanelQuitting()
        {
            ...
            if (ExitPanelController.topText != null)
                ExitPanelController.topText.text = PluginConfig.Instance.QuitTextContent;
        }
        ...
        private void ChangeForPanelRestarting()
        {
            ...
            if (ExitPanelController.topText != null)
                ExitPanelController.topText.text = PluginConfig.Instance.RestartTextContent;
        }
